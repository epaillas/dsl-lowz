...
features_combined = []
for name in ['wtheta', 'DSC', 'gammat', 'DSL']:
    data_fn = f'/pscratch/sd/e/epaillas/dsl-lowz/{name}.npy'
    features_combined.append(np.load(data_fn)[100:])
features = np.concatenate(features_combined, axis=1)
